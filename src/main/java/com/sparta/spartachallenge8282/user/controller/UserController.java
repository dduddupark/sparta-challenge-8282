...
public class UserController {
     ...
     */
    @GetMapping("/me")
    public ResponseEntity<ApiResponse<UserResponse>> getMyInfo(@AuthenticationPrincipal UserDetailsImpl userDetails) {
    ...
    public ResponseEntity<ApiResponse<UserResponse>> updateMyInfo(
        ...
        return ResponseEntity.ok(ApiResponse.success("회원 정보 수정 완료", data));
    }
